...
# 2.8 vs 4.5.3 changes
# INFO_MT_file_import (old) -> TOPBAR_MT_file_import (new)
# INFO_MT_file_export (old) -> TOPBAR_MT_file_export (new)
# Replaced all old references with new 9/20/2025 -VV
def register():
